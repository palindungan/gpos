                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nm_level" name="nm_level" placeholder="Nama Level" required="" oninvalid="this.setCustomValidity('Isi Nama Level')" oninput="setCustomValidity('')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="jml_max">Jumlah Max</label>
                                <input type="text" class="form-control" id="jml_max" name="jml_max" placeholder="Jumlah Max" required="" oninvalid="this.setCustomValidity('Isi Jumlah Max')" oninput="setCustomValidity('')">
                            </div>
                        </div>
                    </div>
