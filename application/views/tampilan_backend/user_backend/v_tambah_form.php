                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nm_user_b" name="nm_user_b" placeholder="Nama User" required="" oninvalid="this.setCustomValidity('Isi Nama User')" oninput="setCustomValidity('')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email_user_b" name="email_user_b" placeholder="Email" required="" oninvalid="this.setCustomValidity('Isi Alamat Email')" oninput="setCustomValidity('')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="almt_user_b" rows="3" name="almt_user_b" required="" oninvalid="this.setCustomValidity('Isi Alamat')" oninput="setCustomValidity('')"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
